...
nickname
'''
@app.route('/dosaveissue', methods=['GET'])
def doSaveIssue():
    issue = {}
    res = {}
    if request.method == 'GET':
...
issue_id
'''
@app.route('/getissueinfo', methods=['GET'])
def goIssueInfo():
    result = {}
    if request.method == 'GET':
...
type
'''
@app.route('/addengineer', methods=['GET'])
def goAddEngineer():
    engineer = {}
    engineer_id = ''
    if request.method == 'GET':
...
engineer_id
'''
@app.route('/getengineerinfo', methods=['GET'])
...
license_num
'''
@app.route('/getengineerlist', methods=['GET'])
...
nickname
'''
@app.route('/updateengineerinfo', methods=['GET'])
...
openId
'''
@app.route('/gocompanyissuelist', methods=['GET'])
...
nickname
'''
@app.route('/dosavelogs', methods=['GET'])
def doSaveLogs():
    issue = {}
    message = ''
    if request.method == 'GET':
...
engineer_id
'''
@app.route('/deleteengineer', methods=['GET'])
